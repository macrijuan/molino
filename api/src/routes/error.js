module.exports = {
  ...
  cantContain: function(dataName, data){return `The ${dataName} can't contain ${data}.`;},
  ...
  wrongLengthBetween: function(dataName, minLen, maxLen){return`The ${dataName} must contain between ${minLen} and ${maxLen} characters.`;},
